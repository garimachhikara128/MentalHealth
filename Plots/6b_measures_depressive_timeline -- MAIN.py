...
for i in range(0,6) :
    ...
    for j in range(0,3) :
        ...
        print("Mean(Deviation) " , round(np.mean(ll_info_like[i][j]),2) , "(" , round(np.std(ll_info_like[i][j]),2), ")")
...
for i in range(0,6) :
    ...
    for j in range(0,3) :
        ...
        print("Mean(Deviation) " , round(np.mean(ll_info_mention[i][j]),2) , "(" , round(np.std(ll_info_mention[i][j]),2), ")")
...
bars1.set_ylabel('Avg. number of replies per post', fontdict={'fontsize':17})
bars1.set_xlabel('Year', fontdict={'fontsize':17})
...
#         legend = False,
#         )
# bars2.set_ylabel('Avg. number of likes per post', fontdict={'fontsize':17})
# bars2.set_xlabel('Year', fontdict={'fontsize':17})
...
#         legend = False,
#         )
# bars3.set_ylabel('Avg. number of retweets per post', fontdict={'fontsize':10})
# bars3.set_xlabel('Year', fontdict={'fontsize':10})
...
#         legend = False,
#         )
# bars4.set_ylabel('Number of mentions per tweet', fontdict={'fontsize':17})
# bars4.set_xlabel('Year', fontdict={'fontsize':17})

# plt.legend(loc = "upper left", fontsize= 17)
# plt.savefig("/Users/garima/Desktop/Self/PhD/Research Work/Mental Health/Phase 2/13_DataTabular/plot_measures_depressive_mention.pdf", format="pdf", bbox_inches="tight")
# plt.show()